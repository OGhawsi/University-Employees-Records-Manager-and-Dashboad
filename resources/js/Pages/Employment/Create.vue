      ...
      <div class="flex justify-between my-12">
        ...
        <div class="w-full flex-shrink px-8 items-center">
            ...
            >
              ...
              />
              <div
                class=" h-8 placeholder-gray-300 border-r-2 transform rotate-12border-gray-500"
              ></div>
              <input
                dir="rtl"
                type="text"
...
export default {
  ...
  data() {
	...
	sending:false,
      form: this.$inertia.form({
        ...
        rewards: null,
        rewards_english: null,
        penalties: null,
        penalties_english: null,
        post_title: null,
        post_title_english: null,
        post_code: null,
        designation: null,
        employment_letter_number: null,
        academic_rank: 1,
  ...
  methods: {
    submit() {
      this.form.post(route("employment.store", this.employee.id), {
        preserverState: true,
        preserveScroll: true,
